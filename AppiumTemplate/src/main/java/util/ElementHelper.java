...
public class ElementHelper {
    ...
    public WebElement find(By Locater){
        try {
            return appiumDriver.findElement(Locater);
    ...
    public Boolean isDisplayed(By key) {
        return find(key).isDisplayed();

    }

    public void isA(By Locate) {
        try {
            List<WebElement> elements = appiumDriver.findElements(Locate);
            if (!elements.isEmpty()) {
